...
class TestDiscordCategory:
    ...
    def test_create_category_with_required_fields(self) -> None:
        ...
        category = DiscordCategory(id=123456789, name="General", server_id=987654321)
    ...
    def test_category_to_discord_format(self) -> None:
        ...
        category = DiscordCategory(id=123, name="Test", server_id=456, position=5)
    ...
    def test_category_name_too_long(self) -> None:
        ...
        with pytest.raises(ValidationError):
            DiscordCategory(id=123, name="a" * 101, server_id=456)

    def test_category_name_not_blank(self) -> None:
        """Category name cannot be blank."""

        with pytest.raises(ValidationError):
            DiscordCategory(id=123, name="   ", server_id=456)
...
class TestDiscordTextChannel:
    ...
    def test_create_channel_with_required_fields(self) -> None:
        ...
        channel = DiscordTextChannel(id=111, name="general", server_id=222)
    ...
    def test_channel_with_category(self) -> None:
        ...
        channel = DiscordTextChannel(id=111, name="announcements", category_id=333, server_id=222)
    ...
    def test_channel_to_discord_format(self) -> None:
        ...
        channel = DiscordTextChannel(id=10, name="test-channel", category_id=None, server_id=20, position=3)
...
class TestDiscordMessage:
    ...
    def test_create_message(self) -> None:
        ...
        now = datetime.utcnow()
        msg = DiscordMessage(id=777, content="Hello world", author_id=888, channel_id=999, timestamp=now)
        assert msg.id == 777
    ...
    def test_message_content_max_length(self) -> None:
        ...
        with pytest.raises(ValidationError):
            DiscordMessage(id=1, content="a" * 2001, author_id=2, channel_id=3, timestamp=datetime.utcnow())
    ...
    def test_message_to_discord_format_with_no_edit(self) -> None:
        ...
        now = datetime.utcnow()
        msg = DiscordMessage(id=10, content="Hello", author_id=20, channel_id=30, timestamp=now)
        result = msg.to_discord_format()
...
class TestDiscordUser:
    ...
    def test_create_user(self) -> None:
        ...
        user = DiscordUser(id=555, username="testuser")
        assert user.id == 555
    ...
    def test_create_bot_user(self) -> None:
        ...
        bot_user = DiscordUser(id=666, username="coolbot", bot=True)
